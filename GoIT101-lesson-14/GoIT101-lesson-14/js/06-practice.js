...
function handleSearch(event) {
  ...
  // car[options] - динамічне звернення до властивості обʼєкту, 
  // константа options це значення поля select option, яке вибирає користувач, воно може бути або car або type.
  // Ми знаємо, що в обʼєкті автомобіля є поля car і type.Але не знаємо що точно вибере користувач,
  //   тому зберігаємо результат вибору у констату і динамічно звертаємось до властивості обʼєкту.
  //     Тобто, замість car[options]  може бути або car.type або car.car
