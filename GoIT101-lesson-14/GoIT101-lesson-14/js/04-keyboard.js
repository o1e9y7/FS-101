...
function handleKeyDown(event) {
  console.log(event);
  //  event.code  - властивість у якій зберігається код клавіші. 
  // Він не залежить від розкладки клавіатури, а орієнтується на фізічне розташування клавіші.
  // Ми його використовуємо тоді, коли хочемо щоб наша комбінація працювала коректно в не залежності від мови та розкладки користувача
